...
Welcome to the Zepid AI platform FAQ page! This comprehensive guide answers the most common questions about using the Zepid platform, from getting started to advanced features. If you can't find the answer you need here, don't hesitate to contact us through our GitHub community, where our team and community members are ready to help.

This FAQ covers everything from basic functionality to advanced features, providing solutions to technical issues and practical tips on how to use the platform efficiently. Through this guide, you can quickly find the information you need to make full use of Zepid's powerful features for a smoother, more efficient development experience.

## Getting Started

### What can I build with Zepid?

Zepid enables you to create a wide range of applications, including user-facing platforms, business tools, and MVPs for market validation. Discover endless possibilities and draw inspiration from our thriving community.
...
**Community Showcase:** When you visit the platform, you'll discover various tools and applications created by our community. From functional prototypes to experimental projects, this collection showcases Zepid's unlimited possibilities.

### How do I start my project?

Starting a project with Zepid is simple and flexible. Choose the method that best suits your preferences and resources:

#### Prompt-based Development
Zepid's prompt-based system makes application creation intuitive. Simply describe what you want to build in the prompt box. The more specific your description, the better the results.
...
### How do I remove the "Built with Zepid" badge from deployed pages?

For free users, the "Built with Zepid" badge cannot be removed. If you upgrade to a Pro or Max plan, the badge will be automatically removed.
...
- 🌐 **Website**: [zepid.dev](https://zepid.dev) for major version releases
...
Our community and team are always ready to help you succeed on the Zepid AI platform!
