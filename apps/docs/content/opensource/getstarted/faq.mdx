...
Welcome to the Zepid AI FAQ! This comprehensive guide addresses the most common questions about using Zepid, from getting started to advanced features. If you can't find the answer you're looking for here, don't hesitate to reach out to our community on [Forum](https://forum.zepid.dev) where our team and community members are always ready to help.

## Getting Started

### What is Zepid AI?

Zepid AI is an open-source, full-stack application generation platform that combines the rapid UI generation experience of V0 with the backend flexibility of modern development tools. It's completely self-hostable with no vendor lock-in, giving you complete control over your code, data, and design system.

### How is Zepid different from V0 or Lovable?

While V0 provides instant UI generation but lacks backend flexibility and self-hosting options, and other platforms may tie you to specific databases or billing models, Zepid combines the best of both worlds:
...
### Do I need coding experience to use Zepid?

No! Zepid is designed to be accessible to users of all skill levels:
...
Building with Zepid is an excellent way to learn web development in a practical, hands-on manner, with AI support always available to guide you through the process.

### What can I build with Zepid?
...
Currently, Zepid focuses on generating new applications from natural language descriptions. Integration with design tools like Figma and version control systems like GitHub are planned for future releases.

### How do I manage multiple projects?

Zepid provides a centralized dashboard where you can:
...
Team collaboration features are currently in development. You can track progress and request early access through our [Community Forum](https://forum.zepid.dev).

## Technical Questions

### What technologies does Zepid use?

Zepid is built on a modern tech stack:
...
Zepid supports multiple database options:
...
Absolutely! Zepid provides flexible design system choices:
...
### How do I deploy my Zepid application?
...
Detailed deployment guides are available in our [technical documentation](https://docs.zepid.dev//deploy).
...
Zepid applications are built with responsive design by default. If you're experiencing mobile issues:
...
### Is Zepid free to use?

Yes! Zepid offers a generous free tier perfect for learning and small projects. Our pricing structure includes:
...
Pricing is based on usage and features accessed. We offer transparent, scalable pricing with no hidden fees. Learn more about [pricing details](https://zepid.dev/pricing) on our website.
...
| ❓ **Usage Questions** | [Community Forum](https://forum.zepid.dev) | Real-time response |
| 🏢 **Business Inquiries** | [contact@zepid.dev](mailto:contact@zepid.dev) | 1 business day |

### How can I contribute to Zepid?
...
Yes! Join our active Community Forum at [forum.zepid.dev](https://forum.zepid.dev) where you can:
...
- 💬 **Forum**: [Join our community](https://forum.zepid.dev) for announcements
- 📖 **Documentation**: [docs.zepid.dev](https://docs.zepid.dev/) for feature guides
- 🌐 **Website**: [zepid.dev](https://zepid.dev) for major releases

## Advanced Features

### Can I extend Zepid with custom functionality?

Absolutely! Zepid is designed for extensibility:
...
Zepid supports integration with various external services:
...
### Can I white-label Zepid for my clients?

Yes! Under the AGPL-3.0 license, you can:
- ✅ Use Zepid for commercial projects
- ✅ Modify and customize the platform
- ✅ Deploy for clients (with proper attribution)
- ✅ Offer Zepid-based services

However, you must:
- ⚠️ Keep the source code open if you distribute modifications
- ⚠️ Provide proper attribution to the Zepid project
- ⚠️ Share any improvements back to the community

For commercial licensing options, contact us at [contact@zepid.dev](mailto:contact@zepid.dev).
...
- 💬 **Join our Forum**: [forum.zepid.dev](https://forum.zepid.dev) for real-time community support
- 📧 **Email us**: [contact@zepid.dev](mailto:contact@zepid.dev) for business inquiries
...
Our community and team are always ready to help you succeed with Zepid AI!
